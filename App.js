...
function App() {
  ...
  // Sends the chat transcript to Qualtrics as a URL parameter
  function endChat() {
    const jsonString = JSON.stringify(messages);
    const encoded = encodeURIComponent(jsonString);
window.location.href = `https://sjsu.qualtrics.com/jfe/form/SV_5AAlLVC6UGEJtGu?transcript=${encoded}`;  }
  ...
  return (
    <div className="App">
      <div className="chat-container">
        ...
        <button onClick={endChat} className="finish-btn">Finish Chat & Continue to Survey</button>
      </div>
    </div>
  );
}
